...
class CustomerAuthTokenResolver
{
    public function __construct(
        private readonly CustomerAccessSessionService $accessSessionService,
    ) {}
    ...
    public function resolveContextFromRequest(Request $request): array
    {
        ...
        if ($providedToken !== '') {
            $accessSession = $this->accessSessionService->resolveActiveSessionByPlainTextToken($providedToken);
            if ($accessSession) {
