...
use App\Http\Requests\Staff\PayReservationDepositRequest;
...
class StaffReservationDepositController extends Controller
{
    ...
    private function transformPayment(?Payment $payment): ?array
    {
        ...
        return [
            ...
            'refund_target_payment_type' => $payment->payment_type === 'Refund'
                ? \App\Support\PaymentSummary::resolveRefundTargetPaymentType($payment)
                : null,
