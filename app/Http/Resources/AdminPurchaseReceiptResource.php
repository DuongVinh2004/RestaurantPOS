...
class AdminPurchaseReceiptResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'lines' => $this->whenLoaded('lines', fn () => AdminPurchaseReceiptLineResource::collection($this->lines)->toArray($request)),
