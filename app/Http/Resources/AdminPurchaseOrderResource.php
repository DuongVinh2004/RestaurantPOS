...
class AdminPurchaseOrderResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'lines' => $this->whenLoaded('lines', fn () => AdminPurchaseOrderLineResource::collection($this->lines)->toArray($request)),
            'receipts' => $this->whenLoaded('receipts', fn () => AdminPurchaseReceiptResource::collection($this->receipts)->toArray($request)),
