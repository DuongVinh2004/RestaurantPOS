...
use App\Modules\InventoryProcurement\Http\Requests\Admin\CreateIngredientRequest;
use App\Modules\InventoryProcurement\Http\Requests\Admin\CreateIngredientStockMovementRequest;
use App\Modules\InventoryProcurement\Http\Requests\Admin\ListIngredientsRequest;
use App\Modules\InventoryProcurement\Http\Requests\Admin\ListIngredientStockMovementsRequest;
use App\Modules\InventoryProcurement\Http\Requests\Admin\UpdateIngredientRequest;
use App\Modules\InventoryProcurement\Http\Requests\Admin\SyncMenuItemRecipeRequest;
use App\Modules\InventoryProcurement\Http\Resources\Admin\IngredientResource;
use App\Modules\InventoryProcurement\Http\Resources\Admin\IngredientStockMovementResource;
use App\Modules\InventoryProcurement\Http\Resources\Admin\MenuItemRecipeLineResource;
use App\Platform\FeatureFlags\Services\FeatureFlagService;
use App\Modules\InventoryProcurement\Application\UseCases\Inventory\InventoryManagementService;
...
class InventoryAdjustmentController extends Controller
{
    ...
    public function listIngredients(ListIngredientsRequest $request): JsonResponse
    {
    ...
    public function showIngredient(int $id, ListIngredientsRequest $request): JsonResponse
    {
        $this->assertInventoryUpliftEnabled($request);
        try {
    ...
    public function updateIngredient(int $id, UpdateIngredientRequest $request): JsonResponse
    {
        $this->assertInventoryUpliftEnabled($request);
        try {
    ...
    public function showMenuItemRecipe(int $id, ListIngredientsRequest $request): JsonResponse
    {
        $this->assertInventoryUpliftEnabled($request);
        try {
        ...
        return response()->json([
            'data' => MenuItemRecipeLineResource::collection($result['lines'])->toArray($request),
            'meta' => [
                'item' => [
    ...
    public function upsertMenuItemRecipe(int $id, SyncMenuItemRecipeRequest $request): JsonResponse
    {
        $this->assertInventoryUpliftEnabled($request);
        try {
    ...
    public function listIngredientMovements(int $id, ListIngredientStockMovementsRequest $request): JsonResponse
    {
        $validated = $request->validated();
        ...
        return response()->json([
            'data' => IngredientStockMovementResource::collection(collect($paginator->items()))->toArray($request),
            'meta' => ListingMetaFactory::paginated(
                $paginator,
                [
    ...
    public function createIngredientMovement(int $id, CreateIngredientStockMovementRequest $request): JsonResponse
    {
        $validated = $request->validated();
        $this->assertInventoryUpliftEnabled(
            $request,
        ...
        return response()->json([
            'data' => (new IngredientStockMovementResource($result['movement']))->toArray($request),
            'meta' => [
