...
namespace App\Modules\CheckoutPayments\Http\Controllers;

use App\Http\Controllers\Controller;
use App\Modules\CheckoutPayments\Infrastructure\PaymentProviders\PaymentWebhookIngestionService;
...
class PaymentProviderWebhookController extends Controller
{
    public function __construct(
        private readonly PaymentWebhookIngestionService $service,
    ) {}
