...
namespace App\Modules\CheckoutPayments\Http\Controllers\Customer;
...
use App\Modules\CheckoutPayments\Http\Requests\Customer\MutateCustomerReservationDepositPaymentSessionRequest;
use App\Modules\CheckoutPayments\Http\Resources\CustomerReservationDepositPaymentSessionResource;
...
class CustomerReservationDepositPaymentController extends Controller
{
    ...
    public function store(int $id, CreateCustomerReservationDepositPaymentSessionRequest $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => [
                ...
                'payment_session' => new CustomerReservationDepositPaymentSessionResource($result['payment_session']),
            ],
        ], 201);
    }
    ...
    public function refresh(int $id, int $sessionId, MutateCustomerReservationDepositPaymentSessionRequest $request): JsonResponse
    {
        $validated = $request->validated();
        $context = $this->resolveCustomerContext($request, $validated);
        $request->attributes->set('reservation_access_scope', $context['scope']);
    ...
    public function confirm(int $id, int $sessionId, MutateCustomerReservationDepositPaymentSessionRequest $request): JsonResponse
    {
        $validated = $request->validated();
        $context = $this->resolveCustomerContext($request, $validated);
        $request->attributes->set('reservation_access_scope', $context['scope']);
