...
namespace App\Modules\Waitlist\Http\Controllers\Customer;

use App\Http\Controllers\Controller;
use App\Modules\Waitlist\Application\Services\CustomerWaitingListService;
...
use App\Modules\Waitlist\Http\Resources\Customer\WaitlistResource;
...
class WaitlistController extends Controller
{
    ...
    public function accept(int $id, RespondWaitlistInviteRequest $request): JsonResponse
    {
        $ownerUserId = $this->authenticatedOwnerId($request);
    ...
    public function confirmArrival(int $id, RespondWaitlistInviteRequest $request): JsonResponse
    {
        $ownerUserId = $this->authenticatedOwnerId($request);
    ...
    public function decline(int $id, RespondWaitlistInviteRequest $request): JsonResponse
    {
        $ownerUserId = $this->authenticatedOwnerId($request);
    ...
    public function cancel(int $id, RespondWaitlistInviteRequest $request): JsonResponse
    {
        $ownerUserId = $this->authenticatedOwnerId($request);
