...
namespace App\Modules\PrivacyCompliance\Http\Controllers\Staff;

use App\Http\Concerns\ResolvesStaffActor;
use App\Http\Controllers\Controller;
use App\Modules\FloorOperations\Application\Queries\StaffBranchContextService;
use App\Modules\PrivacyCompliance\Application\Queries\Audit\AuditTrailQueryHandler;
use App\Modules\PrivacyCompliance\Http\Requests\Staff\ListAuditTrailRequest;
...
class AuditTrailController extends Controller
{
    ...
    public function __construct(
        private readonly AuditTrailQueryHandler $auditTrailQueryService,
