...
namespace App\Modules\Cashiering\Infrastructure\Persistence;
...
class CashieringReplayRecorder
{
    ...
    public function recordSuccess(
        ...
        $this->assertReplayMatches(
            ...
            message: 'This idempotency key is already bound to a different cashiering mutation request payload.'
        );
    }
