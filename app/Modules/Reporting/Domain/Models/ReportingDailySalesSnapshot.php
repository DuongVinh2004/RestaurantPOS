...
class ReportingDailySalesSnapshot extends Model
{
    ...
    protected $casts = [
        ...
        'gross_bill_amount' => 'decimal:0',
        'discount_amount' => 'decimal:0',
        'billed_total_amount' => 'decimal:0',
        'invoice_issued_count' => 'int',
        'invoiced_total_amount' => 'decimal:0',
        'invoiced_tax_amount' => 'decimal:0',
        'payment_row_count' => 'int',
        'refund_row_count' => 'int',
        'captured_amount' => 'decimal:0',
        'refunded_amount' => 'decimal:0',
        'net_paid_amount' => 'decimal:0',
        'deposit_net_amount' => 'decimal:0',
        'final_net_amount' => 'decimal:0',
        'cashier_shift_closed_count' => 'int',
        'cash_discrepancy_amount' => 'decimal:0',
