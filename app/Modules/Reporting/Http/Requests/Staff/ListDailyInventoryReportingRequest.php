...
class ListDailyInventoryReportingRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'ingredient_id' => $this->normalizeListingInteger('ingredient_id'),
    ...
    public function rules(): array
    {
        return [
            ...
            'ingredient_id' => ['nullable', 'integer', 'min:1', 'exists:ingredients,ingredient_id'],
