...
namespace App\Modules\KitchenDispatch\Http\Resources\Staff;
...
class KitchenTicketResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'routing' => [
                'route_present' => $reconciliation['route_present'],
            ...
            'reconciliation' => [
                ...
                'drift_reasons' => array_values($reconciliation['drift_reasons']),
                'next_actions' => array_values($reconciliation['next_actions']),
            ],
