...
class CreateTableOrderRequest extends FormRequest
{
    ...
    {
        return [
            // Optional: náº¿u khÃ´ng truyá»n, server sáº½ tá»± resolve reservation Ä‘ang phá»¥c vá»¥ cho bÃ n
            'reservation_id' => ['nullable', 'integer', 'min:1'],

            // Cho phÃ©p táº¡o order rá»—ng (POS thÆ°á»ng táº¡o trÆ°á»›c, add items sau)
