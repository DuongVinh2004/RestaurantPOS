...
namespace App\Modules\Payments\Http\Resources\Customer;
...
class ReservationDepositPaymentSessionResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            'deposit_payment_session_id' => (int) $this->deposit_payment_session_id,
