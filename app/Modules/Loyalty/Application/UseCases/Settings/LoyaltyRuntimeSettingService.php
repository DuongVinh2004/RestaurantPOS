...
namespace App\Modules\Loyalty\Application\UseCases\Settings;
...
class LoyaltyRuntimeSettingService
{
     ...
     */
    public function listLoyaltySettings(): array
    {
     ...
     */
    public function upsertLoyaltySetting(array $payload, ?int $actorUserId = null): array
    {
        ...
        foreach ($this->listLoyaltySettings() as $setting) {
