...
final class LoyaltyTiersBulkDomain extends AbstractMasterDataBulkDomain implements MasterDataBulkDomain
{
    public function __construct(
        private readonly AdminLoyaltyTierService $tierService,
    ) {
    }
