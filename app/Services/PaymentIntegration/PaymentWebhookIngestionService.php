...
use App\Models\PaymentProviderWebhookReceipt;
...
class PaymentWebhookIngestionService
{
    public function __construct(
        ...
        private readonly ReservationDepositPaymentSessionLifecycleService $depositLifecycle,
        private readonly ReservationBillPaymentSessionLifecycleService $billLifecycle,
    ...
    {
        return ($receipt->delivery_status?->value ?? $receipt->delivery_status) === PaymentProviderWebhookReceiptStatus::Received->value;
    }
