    ...
    private const DOMAIN_DEFINITIONS = [
        [
            ...
            'commands' => [
                ...
                [
                    ...
                    'command' => 'php artisan booking:verify-select --path=app/Services/Staff/StaffCheckoutService.php --json',
                ...
                [
                    'tier' => 'selector-self-check',
                    'command' => 'python .agents/skills/restaurantpos-git-aware-verify/scripts/recommend_from_git.py app/Services/Staff/StaffCheckoutService.php --json',
        ...
        [
            ...
            'fragments' => [
                ...
                'app/services/apiartifacts/apienumstateartifactservice.php',
                'app/services/apiartifacts/apiconsumerartifactservice.php',
        ...
        [
            ...
            'fragments' => [
                ...
                'app/services/staff/refund',
                'app/services/staff/settlement',
        ...
        [
            ...
            'fragments' => [
                ...
                'app/services/notificationoutbox',
