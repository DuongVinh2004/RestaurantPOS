    ...
    private const DOMAIN_DEFINITIONS = [
        ...
        [
            ...
            'fragments' => [
                ...
                'config/staff_capabilities.php',
                'app/http/middleware/',
                'app/modules/identityaccess/infrastructure/tokenization/staffapikeyactorresolver.php',
                'app/modules/identityaccess/application/usecases/authentication/',
        ...
        [
            ...
            'fragments' => [
                ...
                'app/modules/flooroperations/application/queries/staffcheckinreadinessservice.php',
                'app/modules/flooroperations/application/usecases/boards/staffreservationboardassignmentservice.php',
                'app/modules/flooroperations/application/usecases/boards/staffmovetableservice.php',
                'app/modules/flooroperations/application/usecases/boards/stafftablereleaseservice.php',
                'app/modules/flooroperations/application/usecases/checkin/staffcheckinservice.php',
                'app/modules/flooroperations/application/usecases/servicesessions/staffservicesessionservice.php',
                'app/modules/flooroperations/domain/guards/',
                'app/modules/flooroperations/http/controllers/staff/',
        ...
        [
            ...
            'fragments' => [
                'app/modules/ordering/application/queries/stafforderreadservice.php',
                'app/modules/ordering/application/usecases/orders/stafftableorderservice.php',
                'app/modules/ordering/application/usecases/orderitems/stafforderitemlifecycleservice.php',
                'app/modules/ordering/domain/models/reservationorder.php',
                'app/modules/ordering/domain/models/reservationorderitem.php',
                'app/modules/ordering/http/controllers/staff/reservationordercontroller.php',
                'app/modules/ordering/http/controllers/staff/orderitemlifecyclecontroller.php',
                'app/modules/ordering/http/controllers/staff/orderreadcontroller.php',
        ...
        [
            ...
            'fragments' => [
                ...
                'app/http/controllers/api/customerwaitinglistcontroller.php',
                'app/services/customerwaitinglistservice.php',
