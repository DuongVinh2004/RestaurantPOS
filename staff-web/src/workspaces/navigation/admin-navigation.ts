    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          key: 'admin-benefits',
          label: 'Ưu đãi',
          path: staffRoutePaths.admin.benefits,
          iconKey: 'finance',
          workspace: 'admin',
          capability: 'voucher.master_data.manage',
          description: 'Voucher, hạng khách thân thiết và cấu hình điểm thưởng.',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          path: staffRoutePaths.admin.privacy,
          iconKey: 'audit',
          workspace: 'admin',
          capability: 'privacy.manage',
          description: 'Rà soát yêu cầu dữ liệu cá nhân và xuất dữ liệu khách.',
        },
      ],
    },
  ],
