...
describe('WaitingListPage', () => {
  ...
  it('reuses the table_id from board journey context when notifying a waiting entry', async () => {
    renderWithProviders('/ops/waiting-list?source=board&table_id=12');
  ...
  it('respects the focus query param so linked conversations open the intended waiting entry', async () => {
    ...
    renderWithProviders('/ops/waiting-list?focus=77');
    ...
    <AntdApp>
      <QueryClientProvider client={queryClient}>
        <MemoryRouter initialEntries={[initialEntry]} future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          <Routes>
            <Route path="/ops/waiting-list" element={<WaitingListPage />} />
            <Route path="/ops/orders" element={<div data-testid="orders-destination">orders</div>} />
            <Route path="/ops/tables" element={<div data-testid="tables-destination">tables</div>} />
          </Routes>
          <LocationProbe />
        </MemoryRouter>
      </QueryClientProvider>
