...
describe('OrderWorkspacePage', () => {
  ...
  it('ignores stale flow-store ids when the url has no active order journey', async () => {
    ...
    const view = renderWithProviders('/ops/orders');
  ...
  it('renders snapshot guest and multi-table context from journey metadata', async () => {
    ...
    renderWithProviders('/ops/orders?source=reservation&reservation_id=34&reservation_row_version=5&table_ids=12,14&order_id=56&order_row_version=10');
    ...
    <AntdApp>
      <QueryClientProvider client={queryClient}>
        <MemoryRouter initialEntries={[initialEntry]} future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          <Routes>
            <Route path="/ops/orders" element={<><OrderWorkspacePage /><LocationProbe /></>} />
