...
const rawApiRequestOperationAllowlist = [
  ...
  'GET /staff/reservations/{id}/preorder',
  ...
  'POST /staff/reservations/{id}/preorder/confirm',
  'POST /staff/reservations/{id}/preorder/convert',
  'POST /staff/reservations/{id}/preorder/reject',
