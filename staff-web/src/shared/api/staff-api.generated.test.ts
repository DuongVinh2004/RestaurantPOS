...
const rawApiRequestOperationAllowlist = [
  ...
  'GET /admin/benefits/loyalty-tiers',
  'GET /admin/benefits/loyalty-tiers/{id}',
  'GET /admin/benefits/loyalty-tiers/export',
  'GET /admin/benefits/vouchers',
  'GET /admin/benefits/vouchers/{id}',
  ...
  'GET /staff/reservations/{id}/loyalty',
  'GET /staff/reservations/{id}/vouchers',
  'GET /staff/reservations/{id}/active-order',
  'GET /staff/tables/{id}/active-order',
  'GET /staff/users/{id}/loyalty',
  'PATCH /admin/benefits/loyalty-tiers/{id}',
  'PATCH /admin/benefits/vouchers/{id}',
  'PATCH /reservations/{id}/status',
  'POST /admin/benefits/loyalty-tiers',
  'POST /admin/benefits/loyalty-tiers/import',
  'POST /admin/benefits/vouchers',
  ...
  'POST /admin/privacy/requests/{id}/review',
  'POST /admin/restaurant/tables/import',
  'POST /admin/settings/benefits',
  'POST /admin/settings/branches/import',
  'POST /staff/conversations/{id}/assign',
  'POST /staff/conversations/{id}/links',
  'DELETE /staff/conversations/{id}/links/reservation',
  'DELETE /staff/conversations/{id}/links/waiting-list',
  'POST /staff/conversations/{id}/workflow-state',
  'POST /staff/finance/invoices/{id}/issue',
  'POST /staff/reservations/{id}/loyalty/redeem',
  'POST /staff/reservations/{id}/loyalty/redeem/release',
  'POST /staff/reservations/{id}/assign-best-fit',
  'POST /staff/reservations/{id}/assign-table',
  'POST /staff/reservations/{id}/move-table',
  'POST /staff/reservations/{id}/voucher/apply',
  'POST /staff/reservations/{id}/voucher/remove',
  'POST /staff/tables/{id}/release',
  'POST /staff/users/{id}/loyalty/adjust',
