...
describe('TableBoardPage', () => {
  ...
  it('creates a phone reservation with guest snapshot fields for the selected table', async () => {
    const view = renderWithProviders('/tables?source=board&table_id=12');
  ...
  it('keeps the next step actionable for selected and reserved tables', async () => {
    ...
    renderWithProviders('/tables?source=board&table_id=21');
  ...
  it('moves a checked-in reservation to a new table and carries order context forward', async () => {
    ...
    renderWithProviders('/tables?source=board&table_id=12&reservation_id=44&reservation_row_version=4&order_id=501&order_row_version=13');
  ...
  it('releases an idle occupied table from the board inspector', async () => {
    ...
    renderWithProviders('/tables?source=board&table_id=33');
  ...
  it('clears stale reservation and order journey params after releasing a table', async () => {
    ...
    renderWithProviders('/tables?source=board&table_id=33&reservation_id=44&reservation_row_version=4&order_id=501&order_row_version=13');
    ...
    <AntdApp>
      <QueryClientProvider client={queryClient}>
        <MemoryRouter initialEntries={[initialEntry]} future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          <Routes>
            <Route path="/tables" element={<TableBoardPage />} />
