export type KitchenTicketStatusFilter = 'all' | 'Queued' | 'Fired' | 'Ready' | 'Completed' | 'Cancelled';
...
function readStatus(value: string | null): KitchenTicketStatusFilter {
  return value === 'Queued' || value === 'Fired' || value === 'Ready' || value === 'Completed' || value === 'Cancelled'
    ? value
    : 'all';
}
