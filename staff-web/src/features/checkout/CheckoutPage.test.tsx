...
describe('CheckoutPage', () => {
  ...
  it('uses the refund preview row version when executing refund only', async () => {
    ...
    const { queryClient } = renderWithProviders('/checkout?source=order&reservation_id=34&reservation_row_version=5&table_ids=12,14&order_id=56&order_row_version=10');
