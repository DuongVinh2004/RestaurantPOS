...
BEGIN
  IF EXISTS (
    ...
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'Duplicate ingredient_stock_movements lineage exists for (reference_type, reference_id). Clean the duplicate rows before adding the uniqueness guard.';
  END IF;
