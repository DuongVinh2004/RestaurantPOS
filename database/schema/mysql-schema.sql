...
CREATE TABLE `branches` (
  ...
  `description` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `timezone` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Asia/Ho_Chi_Minh',
  `currency` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'VND',
...
DROP TABLE IF EXISTS `finance_replay_records`;
...
CREATE TABLE `waiting_list` (
  ...
  `updated_by` int unsigned DEFAULT NULL,
  `row_version` bigint unsigned NOT NULL DEFAULT '1',
  `active_owner_waiting_key` int unsigned GENERATED ALWAYS AS ((case when ((`user_id` is not null) and (`status` in (_utf8mb4'Waiting',_utf8mb4'Notified'))) then `user_id` else NULL end)) STORED,
  PRIMARY KEY (`waiting_id`),
  UNIQUE KEY `uq_waiting_list__active_owner_waiting_key` (`active_owner_waiting_key`),
...
ALTER TABLE `audit_log_subjects` ADD CONSTRAINT `fk_audit_log_subjects__audit_id__audit_logs` FOREIGN KEY (`audit_id`) REFERENCES `audit_logs` (`audit_id`) ON DELETE CASCADE ON UPDATE RESTRICT;
