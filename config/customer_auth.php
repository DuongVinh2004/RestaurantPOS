...
return [
    ...
    'register_throttle_limit' => max(1, (int) env('CUSTOMER_AUTH_REGISTER_THROTTLE_LIMIT', 5)),
    'register_throttle_window_seconds' => max(1, (int) env('CUSTOMER_AUTH_REGISTER_THROTTLE_WINDOW_SECONDS', 300)),
    'register_password_min_length' => max(8, (int) env('CUSTOMER_AUTH_REGISTER_PASSWORD_MIN_LENGTH', 8)),
