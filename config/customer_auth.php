...
return [
    ...
    'session_bound_route_contracts' => [
        'App\Modules\Reservations\Http\Controllers\ReservationController@store' => [
            'require_owned_hold' => true,
        ],
        'App\Modules\Reservations\Http\Controllers\ReservationController@show' => [],
        'App\Modules\Reservations\Http\Controllers\CustomerReservationSelfServiceController@index' => [],
        'App\Modules\Reservations\Http\Controllers\CustomerReservationSelfServiceController@cancel' => [],
        'App\Modules\Reservations\Http\Controllers\CustomerReservationSelfServiceController@reschedule' => [],
        ...
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationDepositPaymentController@store' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationDepositPaymentController@show' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationDepositPaymentController@refresh' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationDepositPaymentController@confirm' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationOrderBillController@show' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationOrderBillController@activeOrder' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationOrderBillController@billPreview' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationBillPaymentController@store' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationBillPaymentController@show' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationBillPaymentController@refresh' => [],
        'App\Modules\CheckoutPayments\Http\Controllers\Customer\CustomerReservationBillPaymentController@confirm' => [],
    ],
];
