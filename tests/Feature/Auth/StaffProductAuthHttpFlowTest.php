...
class StaffProductAuthHttpFlowTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        foreach (['audit_log_subjects', 'audit_logs', 'cashier_shifts', 'branches', 'staff_api_keys', 'customer_access_sessions', 'users', 'roles'] as $table) {
    ...
    public function test_staff_can_login_fetch_current_session_refresh_and_logout(): void
    {
        ...
        $login->assertOk()
            ...
            ->assertJsonPath('data.capability_source', 'role_id_capabilities')
            ...
            ->assertJsonPath('data.startup.branch_access.access_source', 'role_id_branch_scopes')
