...
class ApiConsumerArtifactsGenerateCommandTest extends TestCase
{
    ...
    public function test_api_consumer_artifact_command_generates_collection_templates_sdk_and_uat_environment(): void
    {
        ...
        self::assertStringContainsString('/api/v1/auth/customer/register', json_encode($collection, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE));
        ...
        self::assertStringContainsString('postV1AuthCustomerRegister', $sdk);
        ...
        self::assertStringContainsString('getV1StaffBranches', $sdk);
        self::assertStringContainsString('getV1StaffReservationsReservationId', $sdk);
        self::assertStringContainsString('postV1StaffReservationsIdAssignTable', $sdk);
        self::assertStringContainsString('postV1StaffReservationsIdAssignBestFit', $sdk);
        self::assertStringContainsString('postV1StaffReservationsIdMoveTable', $sdk);
        self::assertStringContainsString('postV1StaffTablesTableIdRelease', $sdk);
        self::assertStringContainsString('getV1StaffTablesTableIdActiveOrder', $sdk);
        ...
        self::assertStringContainsString('postV1StaffWaitingList', $sdk);
        self::assertStringContainsString('postV1StaffWaitingListIdCancel', $sdk);
        self::assertStringContainsString('postV1StaffWaitingListIdAdvance', $sdk);
        ...
        self::assertStringContainsString('getV1StaffFinanceReconciliation', $sdk);
        self::assertStringContainsString('getV1StaffFinanceReconciliationReservationId', $sdk);
        self::assertStringContainsString('getV1StaffFinanceInvoicesReservationId', $sdk);
        self::assertStringContainsString('postV1StaffFinanceInvoicesReservationIdIssue', $sdk);
        self::assertStringContainsString('getV1AdminInventoryIngredientsIdMovements', $sdk);
        self::assertStringContainsString('postV1AdminInventoryIngredientsIdMovements', $sdk);
        self::assertStringContainsString('getV1AdminInventoryPurchaseOrdersIdReceipts', $sdk);
        self::assertStringContainsString('postV1AdminInventoryPurchaseOrdersIdReceipts', $sdk);
        self::assertStringContainsString('postV1AdminBenefitsVouchers', $sdk);
        self::assertStringContainsString('patchV1AdminBenefitsVouchersId', $sdk);
        self::assertStringContainsString('postV1AdminBenefitsLoyaltyTiers', $sdk);
        self::assertStringContainsString('patchV1AdminBenefitsLoyaltyTiersId', $sdk);
        self::assertStringContainsString('getV1AdminSettingsBenefits', $sdk);
        self::assertStringContainsString('postV1AdminSettingsBenefits', $sdk);
        self::assertStringContainsString('getV1AdminPrivacyRequests', $sdk);
        self::assertStringContainsString('getV1AdminPrivacyCustomersUserIdDataExport', $sdk);
        self::assertStringContainsString('postV1AdminPrivacyRequestsRequestIdReview', $sdk);
        ...
        self::assertStringContainsString('- POST api/v1/auth/customer/register', $sdkReadme);
        ...
        self::assertStringContainsString('- GET api/v1/staff/branches', $sdkReadme);
        ...
        self::assertStringContainsString('- POST api/v1/staff/reservations/{id}/assign-table', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/staff/reservations/{id}/assign-best-fit', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/staff/reservations/{id}/move-table', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/staff/tables/{table_id}/release', $sdkReadme);
        self::assertStringContainsString('- GET api/v1/staff/tables/{table_id}/active-order', $sdkReadme);
        ...
        self::assertStringContainsString('- GET api/v1/staff/finance/reconciliation', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/staff/finance/invoices/{reservation_id}/issue', $sdkReadme);
        ...
        self::assertStringContainsString('- POST api/v1/staff/waiting-list', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/staff/waiting-list/{id}/cancel', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/staff/waiting-list/{id}/advance', $sdkReadme);
        ...
        self::assertStringContainsString('- POST api/v1/staff/conversations/{conversation_id}/assign', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/staff/conversations/{conversation_id}/workflow-state', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/staff/conversations/{conversation_id}/links', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/staff/conversations/{conversation_id}/unassign', $sdkReadme);
        self::assertStringContainsString('- GET api/v1/admin/inventory/ingredients/{id}/movements', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/admin/inventory/purchase-orders/{id}/receipts', $sdkReadme);
        self::assertStringContainsString('- GET api/v1/admin/benefits/vouchers', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/admin/settings/benefits', $sdkReadme);
        self::assertStringContainsString('- GET api/v1/admin/privacy/requests', $sdkReadme);
        self::assertStringContainsString('- POST api/v1/admin/privacy/requests/{request_id}/review', $sdkReadme);
        ...
        self::assertStringContainsString('`POST api/v1/staff/waiting-list` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/staff/waiting-list/{id}/cancel` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/staff/waiting-list/{id}/advance` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/staff/orders/{order_id}/pay`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/staff/reservations/{id}/assign-table` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/staff/reservations/{id}/assign-best-fit` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/staff/reservations/{id}/move-table` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/staff/tables/{table_id}/release` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/staff/finance/invoices/{reservation_id}/issue` | `SDK`', $mutationContract);
        ...
        self::assertStringContainsString('`POST api/v1/staff/conversations/{conversation_id}/assign` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/staff/conversations/{conversation_id}/workflow-state` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/admin/inventory/ingredients/{id}/movements` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/admin/inventory/purchase-orders/{id}/receipts` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/admin/benefits/vouchers` | `SDK`', $mutationContract);
        self::assertStringContainsString('`POST api/v1/admin/privacy/requests/{request_id}/review` | `SDK`', $mutationContract);
