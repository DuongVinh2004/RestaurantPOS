...
final class AdminMasterDataRouteSurfaceTest extends TestCase
{
    public function test_admin_menu_benefits_and_settings_routes_are_registered_to_runtime_surface(): void
    {
        $expected = [
            ...
            ['GET', 'v1/admin/menu/categories/export', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@export'],
            ['POST', 'v1/admin/menu/categories/import', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@import'],
            ...
            ['GET', 'v1/admin/menu/items/export', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@export'],
            ['POST', 'v1/admin/menu/items/import', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@import'],
            ['POST', 'v1/admin/menu/items', 'App\\Http\\Controllers\\Api\\Admin\\AdminMenuItemController@store'],
            ['GET', 'v1/admin/menu/prices/export', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@export'],
            ['POST', 'v1/admin/menu/prices/import', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@import'],
            ...
            ['GET', 'v1/admin/benefits/vouchers', 'App\\Http\\Controllers\\Api\\Admin\\AdminVoucherController@index'],
            ['GET', 'v1/admin/benefits/vouchers/export', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@export'],
            ['POST', 'v1/admin/benefits/vouchers/import', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@import'],
            ['POST', 'v1/admin/benefits/vouchers', 'App\\Http\\Controllers\\Api\\Admin\\AdminVoucherController@store'],
            ['PATCH', 'v1/admin/benefits/vouchers/{id}', 'App\\Http\\Controllers\\Api\\Admin\\AdminVoucherController@update'],
            ['GET', 'v1/admin/benefits/loyalty-tiers', 'App\\Http\\Controllers\\Api\\Admin\\AdminLoyaltyTierController@index'],
            ['GET', 'v1/admin/benefits/loyalty-tiers/export', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@export'],
            ['POST', 'v1/admin/benefits/loyalty-tiers/import', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@import'],
            ['POST', 'v1/admin/benefits/loyalty-tiers', 'App\\Http\\Controllers\\Api\\Admin\\AdminLoyaltyTierController@store'],
            ['PATCH', 'v1/admin/benefits/loyalty-tiers/{id}', 'App\\Http\\Controllers\\Api\\Admin\\AdminLoyaltyTierController@update'],
            ['GET', 'v1/admin/settings/benefits', 'App\\Http\\Controllers\\Api\\Admin\\AdminBenefitSettingController@index'],
            ['POST', 'v1/admin/settings/benefits', 'App\\Http\\Controllers\\Api\\Admin\\AdminBenefitSettingController@upsert'],
            ['GET', 'v1/admin/settings/branches', 'App\\Http\\Controllers\\Api\\Admin\\AdminBranchController@index'],
            ['GET', 'v1/admin/settings/branches/export', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@export'],
            ['POST', 'v1/admin/settings/branches/import', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@import'],
