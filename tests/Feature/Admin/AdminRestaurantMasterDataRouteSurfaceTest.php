...
final class AdminRestaurantMasterDataRouteSurfaceTest extends TestCase
{
    public function test_admin_restaurant_master_data_routes_are_registered_to_runtime_surface(): void
    {
        $expected = [
            ...
            ['GET', 'v1/admin/restaurant/tables/export', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@export'],
            ['POST', 'v1/admin/restaurant/tables/import', 'App\\Http\\Controllers\\Api\\Admin\\AdminMasterDataBulkController@import'],
