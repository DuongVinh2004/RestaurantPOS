...
class StaffActorResolverTest extends TestCase
{
    ...
    public function test_it_resolves_database_backed_staff_key_and_touches_last_used_at(): void
    {
        ...
        $result = app(StaffActorResolver::class)->resolveFromProvidedKey('db-staff-key');
    ...
    public function test_it_rejects_revoked_database_backed_staff_key(): void
    {
        ...
        $result = app(StaffActorResolver::class)->resolveFromProvidedKey('revoked-key');
    ...
    public function test_it_rejects_expired_database_backed_staff_key(): void
    {
        ...
        $result = app(StaffActorResolver::class)->resolveFromProvidedKey('expired-key');
    ...
    {
        $result = app(StaffActorResolver::class)->resolveFromProvidedKey('staff-key');
    ...
    public function test_it_uses_database_store_unavailable_fallback_only_when_explicitly_enabled_and_allow_listed(): void
    {
        ...
        $result = app(StaffActorResolver::class)->resolveFromProvidedKey('legacy-secret');
    ...
    public function test_it_blocks_role_name_fallback_in_production_like_environment(): void
    {
        ...
        $result = app(StaffActorResolver::class)->resolveFromProvidedKey('db-role-fallback-key');
