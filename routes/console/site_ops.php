...
Artisan::command('booking:bootstrap-site
    ...
    $payload = [
        ...
        'admin_username' => $command->option('admin-username') ?? config('booking.bootstrap.admin_username'),
        'admin_name' => $command->option('admin-name'),
        'staff_username' => $command->option('staff-username') ?? config('booking.bootstrap.staff_username'),
